...
class B1PmtHit : public G4VHit 
{
  public:
     ...
     ~B1PmtHit();
      ...
      G4bool operator==(const B1PmtHit&) const;
...
extern G4ThreadLocal G4Allocator<B1PmtHit> *B1PmtHitsAllocator;


inline void* B1PmtHit::operator new(size_t) {
  if (!B1PmtHitsAllocator)
    B1PmtHitsAllocator = new G4Allocator<B1PmtHit>;
  return (void*) B1PmtHitsAllocator->MallocSingle();
}


inline void B1PmtHit::operator delete(void* aHit) {
  B1PmtHitsAllocator->FreeSingle((B1PmtHit*) aHit);
}
