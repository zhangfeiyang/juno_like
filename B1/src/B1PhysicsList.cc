...
// construct Bosons://///////////////////////////////////////////////////
void B1PhysicsList::ConstructMyBosons()
{
				// pseudo-particles
...
// construct Hadrons://///////////////////////////////////////////////////
void B1PhysicsList::ConstructMyHadrons()
{
				//  mesons
...
void B1PhysicsList::ConstructMyShortLiveds()
{
...
void B1PhysicsList::AddTransportation() {
				...
				while( (*particleIterator)() ){
								...
								if(particleName == "neutron") 
												pmanager->AddDiscreteProcess(new B1MaxTimeCuts());
								// Energy cuts to kill charged (embedded in method) particles:
								pmanager->AddDiscreteProcess(new B1MinEkineCuts());
...
void B1PhysicsList::ConstructOp() 
{
				...
				theScintProcessDef->SetScintillationYieldFactor(1); //
...
void B1PhysicsList::ConstructHad() 
{
				//Elastic models
...
void B1PhysicsList::ConstructGeneral() {
