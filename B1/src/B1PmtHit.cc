...
G4ThreadLocal G4Allocator<B1PmtHit> *B1PmtHitsAllocator;
...
B1PmtHit::B1PmtHit(const B1PmtHit& right) : G4VHit(right) {
...
G4bool B1PmtHit::operator==(const B1PmtHit& right) const {
