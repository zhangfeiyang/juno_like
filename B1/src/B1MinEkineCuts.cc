...
B1MinEkineCuts::B1MinEkineCuts(const G4String& aName)
  : B1SpecialCuts(aName)
{
    if (verboseLevel>1) {
...
B1MinEkineCuts::B1MinEkineCuts(B1MinEkineCuts&)
  : B1SpecialCuts()
{}


G4double B1MinEkineCuts::PostStepGetPhysicalInteractionLength(
